								...
								<div class="row">
									<div class="col-lg-6">
										<div class="ft-about-feature-list-item d-flex align-items-center">
											...
											<div class="ft-about-feature-text headline pera-content">
												<h3>Our Mission</h3>
												<p>Marble Cargo  Delivery is specailised for deliverying global events,Around the world
												</p>
											</div>
										</div>
									</div>
									<div class="col-lg-6">
										<div class="ft-about-feature-list-item d-flex align-items-center">
											...
											<div class="ft-about-feature-text headline pera-content">
												<h3>Our Vision</h3>
												<p>We strive for a consistent balance between Ecology,Economy and Society
												</p>
											</div>
										</div>
									</div>
